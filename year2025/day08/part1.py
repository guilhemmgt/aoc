...
def main():
    ...
    # connections !!!
    connected = 0
    while (connected < PAIRS_TO_CONNECT):
    ...
    # calculate the product of the length of the 3 biggest circuits
    circuits_lengths = [len(circuits[k]) for k in circuits]
    circuits_lengths.sort()
    res = circuits_lengths[-1] * circuits_lengths[-2] * circuits_lengths[-3]
